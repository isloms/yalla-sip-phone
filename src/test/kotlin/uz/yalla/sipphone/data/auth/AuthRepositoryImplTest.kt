...
class AuthRepositoryImplTest {
    ...
    fun `successful login stores token and returns correct AuthResult`() = runTest {
        ...
        assertEquals("test.uz", authResult.sipCredentials.server)
        assertEquals(5060, authResult.sipCredentials.port)
        assertEquals("103", authResult.sipCredentials.username)
        assertEquals("demo", authResult.sipCredentials.password)
        assertEquals("UDP", authResult.sipCredentials.transport)
